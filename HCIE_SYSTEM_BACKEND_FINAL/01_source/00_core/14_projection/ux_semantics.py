...
class ConfidenceStability(Enum):
    """Confidence stability over recent interactions"""
    UNSTABLE = "unstable"
    STABILIZING = "stabilizing"
    STABLE = "stable"


class ChallengeSuitability(Enum):
    """Suitability of current challenge level"""
    TOO_EASY = "too_easy"
    APPROPRIATE = "appropriate"
    TOO_HARD = "too_hard"


class PacingResponsiveness(Enum):
    """How well pacing matches learner needs"""
    TOO_SLOW = "too_slow"
    WELL_PACED = "well_paced"
    TOO_FAST = "too_fast"


class CognitiveStability(Enum):
    """Stability of cognitive state"""
