...
def test_real_correct_answer_fixed():
    """Test with real task ID and ACTUAL correct answer"""
    base_url = "http://127.0.0.1:8001/api/v1/tasks/submit"
    
    submission = {
        "user_id": "real_correct_fixed_user",
        "task_id": "q19",  # Real task ID
        "node_id": "ct_abstraction",
        "representation": "interactive",
        "answer": "+2",  # ACTUAL correct answer from response
        "response_time": 8.0,
        "mode": "ct"
    }
    
    print("=== Real Correct Answer Test (Fixed) ===")
...
if __name__ == "__main__":
    test_real_correct_answer_fixed()
